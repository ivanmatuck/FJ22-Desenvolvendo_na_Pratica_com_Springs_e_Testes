...
public class SessaoTest {
	...
	public void oPrecoDaSessaoDeveSerIgualASomaDoPrecoDaSalaMaisOPrecoDoFilme() {
		...
		Sala sala = new Sala("Eldorado - IMax", new BigDecimal("20.5").setScale(2));
		Filme filme = new Filme("Rogue One", Duration.ofMinutes(120), "SCI-FI", new BigDecimal("12.0").setScale(2));
	...
	public void garanteQueOLugarA1EstaOcupadoEOsLugaresA2EA3Disponiveis() {
		...
		Filme rogueOne = new Filme("Rogue One", Duration.ofMinutes(120), "SCI_FI", new BigDecimal("12.0").setScale(2));
		Sala eldorado7 = new Sala("Eldorado 7", new BigDecimal("8.5").setScale(2));
